...
RUN mkdir /home/node/.npm-global \
    ...
    && npm install ${npm_registry} -g --only=prod jsrsasign long fs-extra @hyperledger/caliper-core@${caliper_version} @hyperledger/caliper-cli@${caliper_version}
...
RUN caliper bind --caliper-bind-sut fabric:1.4.11
